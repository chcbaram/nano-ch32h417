...
find_program(RISCV_TOOLCHAIN_DIR
    NAMES riscv-wch-elf-gcc.exe riscv-wch-elf-gcc
    HINTS ${RISCV_POSSIBLE_PATHS}
    PATH_SUFFIXES bin
    DOC "RISCV GCC Toolchain Directory"
)

if(NOT RISCV_TOOLCHAIN_DIR)
    message(FATAL_ERROR "RISCV Toolchain not found. Please set RISCV_TOOLCHAIN_DIR environment variable")
endif()
...
# RISCV_TOOLCHAIN_DIR에서 실행 파일 이름을 제거하고 경로만 추출  
get_filename_component(TOOLCHAIN_PATH "${RISCV_TOOLCHAIN_DIR}" DIRECTORY)
